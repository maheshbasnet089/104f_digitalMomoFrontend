...
<div className='flex items-center justify-center h-20vh bg-[#0d1829] '>
    <div className='mx-auto bg-white shadow-xl rounded-3xl'>
         <div className="grid flex-col max-w-sm shadow-sm rounded-3xl bg-slate-100">
      <img
