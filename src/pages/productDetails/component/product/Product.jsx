    ...
    <section className="overflow-hidden text-gray-700 bg-white body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap mx-auto lg:w-4/5">
          <img alt="ecommerce" className="object-cover object-center w-full border border-gray-200 rounded lg:w-1/2" src="https://www.whitmorerarebooks.com/pictures/medium/2465.jpg"/ >
          <div className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
            ...
            <div className="flex">
              <span className="text-2xl font-medium text-gray-900 title-font">NPR {product?.productPrice }</span>
              <button className="flex px-6 py-2 ml-auto text-white bg-red-500 border-0 rounded focus:outline-none hover:bg-red-600">Add To Cart</button>
