            ...
            <div className="container m-auto px-6 pt-32 md:px-12 lg:pt-[4.8rem] lg:px-7">
                <div className="flex flex-wrap items-center px-2 md:px-0">
                    <div className="relative lg:w-6/12 lg:py-24 xl:py-32">
                        <h1 className="text-4xl font-bold text-yellow-900 md:text-5xl lg:w-10/12">Your favorite dishes, right at your door</h1>
                        <form action="" className="w-full mt-12">
                            <div className="relative flex p-1 bg-white border border-yellow-200 rounded-full shadow-md md:p-1">
                                <select className="hidden p-3 bg-transparent rounded-full md:block md:p-4" name="domain" id="domain">
                                ...
                                <button type="button" title="Start buying" className="px-2 py-1 ml-auto text-center transition rounded-full bg-gradient-to-b from-yellow-200 to-yellow-300 hover:to-red-300 active:from-yellow-400 focus:from-red-400 md:px-12">
                                    <span className="hidden font-semibold text-yellow-900 md:block">
    Search
                                    </span>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-2 mx-auto text-yellow-500 md:hidden " fill="currentColor" viewBox="0 0 16 16">
